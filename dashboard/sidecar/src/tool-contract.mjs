...
export const CONNECTOR_TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description:
      ...
      "that timeout can still run the action, so never retry a parked call on your own: a retry can " +
      "run the mutation twice; ask the operator for the outcome. The connector's live " +
