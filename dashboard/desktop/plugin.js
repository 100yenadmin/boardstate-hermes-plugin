...
${Gd(this.phase.value)}</pre>
    ...
    `}},xe=new Map;function Jd(t,e,r){let s=xe.get(t.id);return s||(s=new Kd(t.id),xe.set(t.id,s)),s.setContext(r,t),c`<div class="dashboard-action-button-host" ${Bt(s.rootRef)}></div>`}function Xd(t){let e=t.type==="select"?c`<select class="dashboard-action-form__control" name=${t.name}>
  ...
  `}var J=100,j=40,E=2;function le(t,e,r){let s=r-e;if(s<=0)return j/2;let n=(t-e)/s;return j-E-n*(j-E*2)}function Dt(t,e){return e<=1?J/2:E+t/(e-1)*(J-E*2)}function je(t,e,r){return t.map((s,n)=>`${Dt(n,t.length)},${le(s,e,r)}`).join(" ")}var bl=new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:1});function yt(t){return Number.isFinite(t)?bl.format(t):""}function Hs(t){if(t.length<2)return"flat";let e=t[0],r=t[t.length-1];return r>e?"up":r<e?"down":"flat"}function hl(t){return x`<polyline
    class="dashboard-chart__line"
    fill="none"
    points=${je(t.values,t.min,t.max)}
  />`}function pl(t){let e=je(t.values,t.min,t.max),r=Dt(0,t.values.length),s=Dt(t.values.length-1,t.values.length),n=j-E;return x`<g>
    ...
    ${t.values.map((a,i)=>{let l=le(a,t.min,t.max);return x`<rect x=${E+i*r+s/2} y=${l} width=${n} height=${Math.max(o-l,0)} />`})}
    ...
    <line class="dashboard-chart__gauge-needle" x1=${a} y1=${i} x2=${m.x} y2=${m.y} />
      ...
      <circle class="dashboard-chart__spark-dot" cx=${Dt(0,e)} cy=${le(t.values[0]??0,t.min,t.max)} r="1.5" />
    ...
    ${t.values.map((r,s)=>x`<circle class="dashboard-chart__tip" cx=${Dt(s,e)} cy=${le(r,t.min,t.max)} r="2.5"><title>${yt(r)}</title></circle>`)}
...
${n}</textarea>
  ...
  `}function Cc(t){return t.kind==="agent"?d("dashboard.tabs.groupAgent",{agent:t.agentId??"agent"}):t.kind==="system"?d("dashboard.tabs.groupSystem"):d("dashboard.tabs.groupUser")}function Oc(t,e,r,s){let n=()=>t.onRequestUpdate?.(),o=ne(s),a=ta(o),i=Qo(s),l=a.length>1,u=b=>Gi(t.host,b).length;return c`
  ...
  `}function Xc(t,e,r){let s=r.dialog;if(!s)return p;let n=()=>t.onRequestUpdate?.(),o=()=>{r.dialog=null,n()};if(s.kind==="editTitle"){let u=d("dashboard.widget.editTitleTitle");return Qt(u,o,c`
      ...
      `)}let a=d("dashboard.widget.moveToTabTitle"),i=e.workspace?se(e.workspace).filter(u=>u.slug!==s.slug):[];return Qt(a,o,c`
  ...
  `}function Zc(t,e,r){if(e.error)return c`
    ...
    `;let n=De(s,e.activeSlug)??ne(s)[0];return n?c`
    ${nu(t,e,r,n)}
    ...
    <div class="dashboard-history__restore">
      ${i?o.confirmRestore?c`
                ...
                <button
                  ...
                  @click=${async()=>{o.restoring=!0,t.onRequestUpdate?.(),await bd(e,t.transport),o.restoring=!1,o.confirmRestore=!1,Ee(t,r)}}
                >
  ...
  </svg>`}function hu(t,e,r){let s=(e?t.tabs.find(o=>o.slug===e):void 0)??ne(t)[0]??t.tabs[0];if(!s||s.widgets.length===0)return c`<div class="dashboard-history__preview dashboard-history__preview--empty">
...
`;var bn={"--bs-bg":["--ui-surface-background","--ui-bg-editor"],"--bs-bg-hover":["--ui-row-hover-background","--ui-control-hover-background"],"--bs-bg-muted":["--ui-bg-chrome","--ui-bg-tertiary"],"--bs-surface-muted":["--ui-bg-chrome","--ui-bg-tertiary"],"--bs-card":["--ui-bg-elevated","--ui-surface-background"],"--bs-card-highlight":["--ui-row-active-background","--ui-bg-elevated"],"--bs-border":["--ui-stroke-secondary"],"--bs-border-strong":["--ui-stroke-primary"],"--bs-input":["--ui-bg-input","--ui-control-active-background"],"--bs-text":["--ui-text-primary"],"--bs-text-strong":["--ui-text-primary"],"--bs-text-muted":["--ui-text-tertiary"],"--bs-text-dim":["--ui-text-quaternary","--ui-text-tertiary"],"--bs-muted":["--ui-text-tertiary"],"--bs-accent":["--ui-accent"],"--bs-accent-foreground":["--ui-bg-elevated","--ui-surface-background"],"--bs-ring":["--ui-accent"],"--bs-danger":["--ui-red"],"--bs-success":["--ui-green"],"--bs-warning":["--ui-yellow"]};function hn(t){let e=`var(${t[t.length-1]})`;for(let r=t.length-2;r>=0;r--)e=`var(${t[r]}, ${e})`;return e}function Au(t){let e=t.match(/[\d.]+/g);if(!e||e.length<3)return 0;let r=/^\s*color\(/i.test(t)?1:255,[s,n,o]=e.slice(0,3).map(a=>{let i=Number(a)/r;return i<=.03928?i/12.92:Math.pow((i+.055)/1.055,2.4)});return .2126*s+.7152*n+.0722*o}function pn(t){return Au(t)<.4?"dark":"light"}function Fe(t,e,r){return{schemaVersion:1,workspaceVersion:1,widgetsRegistry:{},prefs:{tabOrder:[t]},tabs:[{slug:t,title:e,icon:"layoutDashboard",hidden:!1,createdBy:"system",widgets:r}]}}var He=(t,e,r,s,n,o,a)=>({id:t,kind:"builtin:markdown",title:e,grid:{x:r,y:s,w:n,h:o},collapsed:!1,hidden:!1,props:{markdown:a}}),H=(t,e,r,s,n,o,a,i={})=>({id:t,kind:e,title:r,grid:{x:s,y:n,w:o,h:a},collapsed:!1,hidden:!1,props:i}),gn=[{id:"agent-hq",name:"Agent HQ",summary:"Live operations overview \u2014 usage, sessions, connected instances, and schedules.",doc:Fe("board","Agent HQ",[He("header","Overview",0,0,12,2,`# Agent HQ
Live operations for this Hermes agent.`),H("usage","builtin:usage","Usage",0,2,4,3),H("instances","builtin:instances","Instances",4,2,4,3),H("sessions","builtin:sessions","Sessions",8,2,4,5),H("cron","builtin:cron","Scheduled jobs",0,5,8,3)])},{id:"usage-cost",name:"Usage & Cost",summary:"Spend and token usage at a glance, with the underlying breakdown.",doc:Fe("board","Usage & Cost",[He("header","Overview",0,0,12,2,`# Usage & Cost
Today's spend and token consumption.`),H("cost","builtin:stat-card","Cost",0,2,3,2,{metric:"todayCost",format:"usd",label:"Cost (today)"}),H("tokens","builtin:stat-card","Tokens",3,2,3,2,{metric:"todayTokens",format:"int",label:"Tokens (today)"}),H("usage","builtin:usage","Usage detail",6,2,6,3),H("cron","builtin:cron","Scheduled jobs",0,5,12,3)].map(t=>t.id==="cost"||t.id==="tokens"?{...t,bindings:{value:{source:"rpc",method:"usage.status"}}}:t))},{id:"sessions-monitor",name:"Sessions Monitor",summary:"Watch active sessions and connected instances in real time.",doc:Fe("board","Sessions Monitor",[He("header","Overview",0,0,12,2,`# Sessions Monitor
Active sessions and connected instances.`),H("sessions","builtin:sessions","Sessions",0,2,7,5),H("instances","builtin:instances","Instances",7,2,5,3),H("usage","builtin:usage","Usage",7,5,5,2)])}];var ku=new Set(["dashboard.widget.approve","dashboard.capability.approve","dashboard.action.confirm","dashboard.action.deny"]);function fn(t,e){return{request(s,n,o){return ku.has(s)?e(s,n??{}):t.request(s,n,o)},addEventListener(s,n){return t.addEventListener(s,n)},close(){t.close()},get ready(){return t.ready},get closed(){return t.closed}}}import{jsx as _t,jsxs as Ge}from"react/jsx-runtime";var qe=!1;function Nu(){if(qe||document.querySelector("style[data-boardstate]")){qe=!0;return}let t=document.createElement("style");t.setAttribute("data-boardstate",""),t.textContent=`${cn}
${un}`,document.head.appendChild(t),qe=!0}function yn(t){let e=getComputedStyle(document.body).backgroundColor||"rgb(0,0,0)";t.setAttribute("data-theme",pn(e));for(let[r,s]of Object.entries(bn))t.style.setProperty(r,hn(s));t.style.setProperty("--bs-radius-lg","var(--radius-xl, 10px)"),t.style.setProperty("--bs-radius-md","0.375rem"),t.style.setProperty("--bs-radius-sm","0.25rem"),t.style.setProperty("--bs-shadow-md","0 1px 3px rgba(0,0,0,0.10)"),t.style.setProperty("--bs-font-sans",getComputedStyle(document.body).fontFamily)}function Mu({operatorRest:t}){let e=mn(null),r=mn(void 0),[s,n]=Ve("connecting"),[o,a]=Ve(""),[i,l]=Ve(""),u=Ru(async(h,m)=>{let w=r.current;if(w&&window.confirm(`Replace the current board with the "${h}" template?`)){l(h);try{await w.request("dashboard.workspace.replace",{doc:m,actor:"user"})}catch(v){Eu.notify?.({kind:"error",message:`Template failed: ${v instanceof Error?v.message:String(v)}`})}finally{l("")}}},[]);return Iu(()=>{Nu();let h=!1,m,w,v;return(async()=>{let g=await window.hermesDesktop?.getConnection?.().catch(()=>null);if(h)return;if(!g){n("error"),a("No desktop gateway connection.");return}if(g.authMode==="oauth"){n("error"),a("The live board needs a local gateway (OAuth remote not yet supported).");return}let $=`${g.baseUrl.replace(/^http/,"ws")}/api/plugins/boardstate/ws?token=${encodeURIComponent(g.token)}`,D=async(B,Y)=>{if(!t)throw new Error("operator endpoint unavailable");return(await t("/operator",{method:"POST",body:{method:B,params:Y}}))?.result};m=fn(Ze($),D),r.current=m,w=document.createElement("boardstate-view"),w.transport=m,w.connected=!0,w.operator=!0,w.basePath="",yn(w),v=new MutationObserver(()=>w&&yn(w)),v.observe(document.documentElement,{attributes:!0,attributeFilter:["class","style","data-theme"]}),v.observe(document.body,{attributes:!0,attributeFilter:["class","style"]}),w.style.display="block",w.style.height="100%",e.current?.appendChild(w),m.ready.then(()=>!h&&n("live")).catch(B=>{h||(n("error"),a(B instanceof Error?B.message:String(B)))})})(),()=>{h=!0,v?.disconnect(),r.current=void 0;try{m?.close()}catch{}w&&w.parentNode&&w.parentNode.removeChild(w)}},[]),Ge("div",{style:{display:"flex",flexDirection:"column",height:"100%",gap:8,padding:12},children:[Ge("div",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:8,fontSize:12},children:[_t("span",{style:{width:8,height:8,borderRadius:"50%",background:s==="live"?"var(--ui-green, #6aa84f)":s==="error"?"var(--ui-red, #e06c75)":"var(--ui-yellow, #d0a94f)",display:"inline-block"}}),_t("span",{style:{opacity:.8},children:s==="live"?"Board connected":s==="error"?`Board unavailable${o?`: ${o}`:""}`:"Connecting to board\u2026"}),s==="live"?Ge("span",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:6,marginLeft:8},children:[_t("span",{style:{opacity:.7},children:"Templates:"}),gn.map(h=>_t("button",{type:"button",title:h.summary,disabled:i!=="",onClick:()=>u(h.name,h.doc),style:{cursor:i?"default":"pointer",padding:"3px 10px",borderRadius:6,border:"1px solid var(--ui-stroke-secondary, #2a2a33)",background:i===h.id?"var(--ui-row-active-background, #23232b)":"transparent",color:"inherit",opacity:i&&i!==h.name?.5:1},children:i===h.name?"Applying\u2026":h.name},h.id))]}):null]}),_t("div",{ref:e,style:{flex:1,minHeight:0}})]})}var jb={id:"boardstate",name:"Board",register(t){t.register({id:"board-route",area:Tu,data:{path:"/board"},render:()=>_t(Mu,{operatorRest:t.rest})}),t.register({id:"board-nav",area:Su,data:{path:"/board",label:"Board",codicon:"dashboard"}})}};export{jb as default};
