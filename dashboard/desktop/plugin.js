...
`)}function Ks(t){return t.status==="ok"?"ok":t.status==="error"?"error":"pending"}function Sl(t){return{turn:{turnId:t,items:[],status:"streaming"},textById:new Map,callById:new Map}}function Rl(t){return t.items[t.items.length-1]}function At(t){for(let e of t.items)e.kind==="error"&&e.retryable&&!e.superseded&&(e.superseded=!0)}function G(t,e,r){let s=t.get(r);return s||(s=Sl(r),t.set(r,s),e.push(r)),s}function Fr(t,e){let r=Rl(t);if(r&&r.kind==="tools"){r.calls.push(e);return}t.items.push({kind:"tools",calls:[e]})}function Il(t){let e=new Map,r=[];for(let s of t)switch(s.type){case"turn-start":G(e,r,s.turnId);break;case"text-start":{let{turn:n,textById:o}=G(e,r,s.turnId);if(At(n),!o.has(s.id)){let a={kind:"text",id:s.id,text:"",closed:!1};o.set(s.id,a),n.items.push(a)}break}case"text-delta":{let{turn:n,textById:o}=G(e,r,s.turnId);At(n);let a=o.get(s.id);a||(a={kind:"text",id:s.id,text:"",closed:!1},o.set(s.id,a),n.items.push(a)),a.text+=s.delta;break}case"text-end":{let n=e.get(s.turnId)?.textById.get(s.id);n&&(n.closed=!0);break}case"tool-call-start":{let{turn:n,callById:o}=G(e,r,s.turnId);if(At(n),!o.has(s.callId)){let a={callId:s.callId,name:s.name,argsText:"",status:"building"};o.set(s.callId,a),Fr(n,a)}break}case"tool-call-delta":{let n=e.get(s.turnId)?.callById.get(s.callId);n&&(n.argsText+=s.argsTextDelta);break}case"tool-call-ready":{let{turn:n,callById:o}=G(e,r,s.turnId);At(n);let a=o.get(s.callId);a||(a={callId:s.callId,name:s.name,argsText:"",status:"building"},o.set(s.callId,a),Fr(n,a)),a.name=s.name,a.args=s.args,a.status="ready";break}case"tool-result":{let n=e.get(s.turnId)?.callById.get(s.callId);n&&(n.ok=s.ok,n.status=s.ok?"ok":"error",s.result!==void 0&&(n.result=s.result),s.error!==void 0&&(n.error=s.error));break}case"usage":{let{turn:n}=G(e,r,s.turnId);n.usage={inputTokens:s.inputTokens,outputTokens:s.outputTokens};break}case"abort":{let{turn:n}=G(e,r,s.turnId);n.status="aborted";break}case"turn-end":{let{turn:n}=G(e,r,s.turnId);if(n.stopReason!==void 0)break;n.stopReason=s.stopReason,n.status=s.stopReason==="aborted"?"aborted":"complete";break}case"error":{let{turn:n}=G(e,r,s.turnId??r[r.length-1]??"");At(n),n.items.push({kind:"error",code:s.code,message:s.message,retryable:s.retryable,superseded:!1});break}default:break}return r.map(s=>e.get(s).turn)}function Js(t){return typeof t=="object"&&t!==null}function kt(t){return typeof t=="string"?t:""}function Hr(t,e){let r=Js(e)?e:{};switch(t.startsWith("dashboard.")?t.slice(10):t){case"tab.create":{let s=kt(r.title)||kt(r.slug);return s?d("dashboard.widget.chat.tool.createdTab",{name:s}):t}case"widget.add":{let s=kt(r.id)||kt(r.widgetId);return s?d("dashboard.widget.chat.tool.addedWidget",{id:s}):t}case"workspace.get":return d("dashboard.widget.chat.tool.readBoard");default:return t}}function Nl(t){return t.map(e=>{let r=Ks(e);return r==="ok"?"\u2713":r==="error"?"\u2717":"\xB7"}).join("")}function Ml(t){return t===1?d("dashboard.widget.chat.actionsOne"):d("dashboard.widget.chat.actionsMany",{count:String(t)})}function Vr(t){try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Cl(t,e){let r=(t.status==="building"||t.status==="ready")&&!t.ok;if(r&&!e)return c`<div class="dashboard-chat__tool-row dashboard-chat__tool-row--building">
  ...
  </details>`}function Ll(t){let e=t.status==="aborted";return c`<div
  ...
  `}function Fl(t,e){let r=Ba(t,e);return r.trim()?c`<div class="dashboard-markdown markdown-body">
    ${qs(Gs(r))}
...
${n}</textarea>
  ...
  `}function Xl(t,e){let r=La(t,e);return c`
...
`;var bn={"--bs-bg":["--ui-surface-background","--ui-bg-editor"],"--bs-bg-hover":["--ui-row-hover-background","--ui-control-hover-background"],"--bs-bg-muted":["--ui-bg-chrome","--ui-bg-tertiary"],"--bs-surface-muted":["--ui-bg-chrome","--ui-bg-tertiary"],"--bs-card":["--ui-bg-elevated","--ui-surface-background"],"--bs-card-highlight":["--ui-row-active-background","--ui-bg-elevated"],"--bs-border":["--ui-stroke-secondary"],"--bs-border-strong":["--ui-stroke-primary"],"--bs-input":["--ui-bg-input","--ui-control-active-background"],"--bs-text":["--ui-text-primary"],"--bs-text-strong":["--ui-text-primary"],"--bs-text-muted":["--ui-text-tertiary"],"--bs-text-dim":["--ui-text-quaternary","--ui-text-tertiary"],"--bs-muted":["--ui-text-tertiary"],"--bs-accent":["--ui-accent"],"--bs-accent-foreground":["--ui-bg-elevated","--ui-surface-background"],"--bs-ring":["--ui-accent"],"--bs-danger":["--ui-red"],"--bs-success":["--ui-green"],"--bs-warning":["--ui-yellow"]};function hn(t){let e=`var(${t[t.length-1]})`;for(let r=t.length-2;r>=0;r--)e=`var(${t[r]}, ${e})`;return e}function Au(t){let e=t.match(/[\d.]+/g);if(!e||e.length<3)return 0;let r=/^\s*color\(/i.test(t)?1:255,[s,n,o]=e.slice(0,3).map(a=>{let i=Number(a)/r;return i<=.03928?i/12.92:Math.pow((i+.055)/1.055,2.4)});return .2126*s+.7152*n+.0722*o}function pn(t){return Au(t)<.4?"dark":"light"}function ue(t,e,r){return{schemaVersion:1,workspaceVersion:1,widgetsRegistry:{},prefs:{tabOrder:[t]},tabs:[{slug:t,title:e,icon:"layoutDashboard",hidden:!1,createdBy:"system",widgets:r}]}}var _t=(t,e,r,s,n,o,a)=>({id:t,kind:"builtin:markdown",title:e,grid:{x:r,y:s,w:n,h:o},collapsed:!1,hidden:!1,props:{markdown:a}}),H=(t,e,r,s,n,o,a,i={})=>({id:t,kind:e,title:r,grid:{x:s,y:n,w:o,h:a},collapsed:!1,hidden:!1,props:i}),ku=(t,e,r,s,n,o,a,i,l,u=null)=>({id:t,kind:"builtin:action-button",title:e,grid:{x:r,y:s,w:n,h:o},collapsed:!1,hidden:!1,props:{connector:a,tool:i,label:l,args:u}}),gn=[{id:"agent-hq",name:"Agent HQ",summary:"Live operations overview \u2014 usage, sessions, connected instances, and schedules.",doc:ue("board","Agent HQ",[_t("header","Overview",0,0,12,2,`# Agent HQ
Live operations for this Hermes agent.`),H("usage","builtin:usage","Usage",0,2,4,3),H("instances","builtin:instances","Instances",4,2,4,3),H("sessions","builtin:sessions","Sessions",8,2,4,5),H("cron","builtin:cron","Scheduled jobs",0,5,8,3)])},{id:"usage-cost",name:"Usage & Cost",summary:"Spend and token usage at a glance, with the underlying breakdown.",doc:ue("board","Usage & Cost",[_t("header","Overview",0,0,12,2,`# Usage & Cost
Today's spend and token consumption.`),H("cost","builtin:stat-card","Cost",0,2,3,2,{metric:"todayCost",format:"usd",label:"Cost (today)"}),H("tokens","builtin:stat-card","Tokens",3,2,3,2,{metric:"todayTokens",format:"int",label:"Tokens (today)"}),H("usage","builtin:usage","Usage detail",6,2,6,3),H("cron","builtin:cron","Scheduled jobs",0,5,12,3)].map(t=>t.id==="cost"||t.id==="tokens"?{...t,bindings:{value:{source:"rpc",method:"usage.status"}}}:t))},{id:"sessions-monitor",name:"Sessions Monitor",summary:"Watch active sessions and connected instances in real time.",doc:ue("board","Sessions Monitor",[_t("header","Overview",0,0,12,2,`# Sessions Monitor
Active sessions and connected instances.`),H("sessions","builtin:sessions","Sessions",0,2,7,5),H("instances","builtin:instances","Instances",7,2,5,3),H("usage","builtin:usage","Usage",7,5,5,2)])},{id:"office-ops",name:"Office Ops",summary:"Operate OfficeCLI \u2014 generate documents and workbooks through approved tools, artifacts on the board.",doc:ue("board","Office Ops",[_t("header","Overview",0,0,12,2,"# Office Ops\nDrive **OfficeCLI** (`officecli mcp`) through operator-approved tools. Author the `officecli` connector in `boardstate.connectors.json`, approve its tools in the approvals panel, then act below."),ku("generate-report","Quarterly report",0,2,4,3,"officecli","create_document","Generate quarterly report .docx",{title:"Quarterly Report",format:"docx"}),_t("artifacts","Artifacts",4,2,8,3,`## Artifacts
Generated documents and workbooks land in your OfficeCLI working directory and are linked here as the agent produces them. A mutating action **parks for your confirm** before it runs; a read-only tool runs directly.`),_t("setup","Setup",0,5,12,2,"### Setup\n1. Install OfficeCLI (`brew install officecli` or a GitHub release) so `officecli` is on PATH.\n2. Author `boardstate.connectors.json` in the state dir with the `officecli` stdio connector.\n3. Approve the tools you want in the approvals panel \u2014 nothing runs until you do.")])}];var Eu=new Set(["dashboard.widget.approve","dashboard.capability.approve","dashboard.action.confirm","dashboard.action.deny"]);function fn(t,e){return{request(s,n,o){return Eu.has(s)?e(s,n??{}):t.request(s,n,o)},addEventListener(s,n){return t.addEventListener(s,n)},close(){t.close()},get ready(){return t.ready},get closed(){return t.closed}}}import{jsx as xt,jsxs as Ge}from"react/jsx-runtime";var qe=!1;function Mu(){if(qe||document.querySelector("style[data-boardstate]")){qe=!0;return}let t=document.createElement("style");t.setAttribute("data-boardstate",""),t.textContent=`${cn}
${un}`,document.head.appendChild(t),qe=!0}function yn(t){let e=getComputedStyle(document.body).backgroundColor||"rgb(0,0,0)";t.setAttribute("data-theme",pn(e));for(let[r,s]of Object.entries(bn))t.style.setProperty(r,hn(s));t.style.setProperty("--bs-radius-lg","var(--radius-xl, 10px)"),t.style.setProperty("--bs-radius-md","0.375rem"),t.style.setProperty("--bs-radius-sm","0.25rem"),t.style.setProperty("--bs-shadow-md","0 1px 3px rgba(0,0,0,0.10)"),t.style.setProperty("--bs-font-sans",getComputedStyle(document.body).fontFamily)}function Cu({operatorRest:t}){let e=mn(null),r=mn(void 0),[s,n]=Ve("connecting"),[o,a]=Ve(""),[i,l]=Ve(""),u=Iu(async(h,m)=>{let w=r.current;if(w&&window.confirm(`Replace the current board with the "${h}" template?`)){l(h);try{await w.request("dashboard.workspace.replace",{doc:m,actor:"user"})}catch(v){Tu.notify?.({kind:"error",message:`Template failed: ${v instanceof Error?v.message:String(v)}`})}finally{l("")}}},[]);return Nu(()=>{Mu();let h=!1,m,w,v;return(async()=>{let g=await window.hermesDesktop?.getConnection?.().catch(()=>null);if(h)return;if(!g){n("error"),a("No desktop gateway connection.");return}if(g.authMode==="oauth"){n("error"),a("The live board needs a local gateway (OAuth remote not yet supported).");return}let $=`${g.baseUrl.replace(/^http/,"ws")}/api/plugins/boardstate/ws?token=${encodeURIComponent(g.token)}`,B=async(L,Y)=>{if(!t)throw new Error("operator endpoint unavailable");return(await t("/operator",{method:"POST",body:{method:L,params:Y}}))?.result};m=fn(Ze($),B),r.current=m,w=document.createElement("boardstate-view"),w.transport=m,w.connected=!0,w.operator=!0,w.basePath="",yn(w),v=new MutationObserver(()=>w&&yn(w)),v.observe(document.documentElement,{attributes:!0,attributeFilter:["class","style","data-theme"]}),v.observe(document.body,{attributes:!0,attributeFilter:["class","style"]}),w.style.display="block",w.style.height="100%",e.current?.appendChild(w),m.ready.then(()=>!h&&n("live")).catch(L=>{h||(n("error"),a(L instanceof Error?L.message:String(L)))})})(),()=>{h=!0,v?.disconnect(),r.current=void 0;try{m?.close()}catch{}w&&w.parentNode&&w.parentNode.removeChild(w)}},[]),Ge("div",{style:{display:"flex",flexDirection:"column",height:"100%",gap:8,padding:12},children:[Ge("div",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:8,fontSize:12},children:[xt("span",{style:{width:8,height:8,borderRadius:"50%",background:s==="live"?"var(--ui-green, #6aa84f)":s==="error"?"var(--ui-red, #e06c75)":"var(--ui-yellow, #d0a94f)",display:"inline-block"}}),xt("span",{style:{opacity:.8},children:s==="live"?"Board connected":s==="error"?`Board unavailable${o?`: ${o}`:""}`:"Connecting to board\u2026"}),s==="live"?Ge("span",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:6,marginLeft:8},children:[xt("span",{style:{opacity:.7},children:"Templates:"}),gn.map(h=>xt("button",{type:"button",title:h.summary,disabled:i!=="",onClick:()=>u(h.name,h.doc),style:{cursor:i?"default":"pointer",padding:"3px 10px",borderRadius:6,border:"1px solid var(--ui-stroke-secondary, #2a2a33)",background:i===h.id?"var(--ui-row-active-background, #23232b)":"transparent",color:"inherit",opacity:i&&i!==h.name?.5:1},children:i===h.name?"Applying\u2026":h.name},h.id))]}):null]}),xt("div",{ref:e,style:{flex:1,minHeight:0}})]})}var Fb={id:"boardstate",name:"Board",register(t){t.register({id:"board-route",area:Su,data:{path:"/board"},render:()=>xt(Cu,{operatorRest:t.rest})}),t.register({id:"board-nav",area:Ru,data:{path:"/board",label:"Board",codicon:"dashboard"}})}};export{Fb as default};
