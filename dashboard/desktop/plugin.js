...
`;var un={"--bs-bg":["--ui-base","--ui-editor-surface-background"],"--bs-bg-hover":["--ui-row-hover-background","--ui-control-hover-background"],"--bs-bg-muted":["--ui-bg-tertiary"],"--bs-surface-muted":["--ui-bg-tertiary"],"--bs-card":["--ui-bg-elevated","--ui-chat-surface-background"],"--bs-card-highlight":["--ui-row-active-background","--ui-bg-elevated"],"--bs-border":["--ui-stroke-secondary"],"--bs-border-strong":["--ui-stroke-primary"],"--bs-input":["--ui-control-active-background","--ui-bg-tertiary"],"--bs-text":["--ui-text-primary","--foreground"],"--bs-text-strong":["--ui-text-primary","--foreground"],"--bs-text-muted":["--ui-text-tertiary"],"--bs-text-dim":["--ui-text-quaternary","--ui-text-tertiary"],"--bs-muted":["--ui-text-tertiary"],"--bs-accent":["--ui-accent"],"--bs-accent-foreground":["--ui-base","--foreground"],"--bs-ring":["--ui-accent"],"--bs-danger":["--ui-red"],"--bs-success":["--ui-green"],"--bs-warning":["--ui-yellow"]};function bn(t){let e=`var(${t[t.length-1]})`;for(let r=t.length-2;r>=0;r--)e=`var(${t[r]}, ${e})`;return e}function _u(t){let e=t.match(/[\d.]+/g);if(!e||e.length<3)return 0;let[r,s,n]=e.slice(0,3).map(o=>{let i=Number(o)/255;return i<=.03928?i/12.92:Math.pow((i+.055)/1.055,2.4)});return .2126*r+.7152*s+.0722*n}function hn(t){return _u(t)<.4?"dark":"light"}function Fe(t,e,r){return{schemaVersion:1,workspaceVersion:1,widgetsRegistry:{},prefs:{tabOrder:[t]},tabs:[{slug:t,title:e,icon:"layoutDashboard",hidden:!1,createdBy:"system",widgets:r}]}}var He=(t,e,r,s,n,o,i)=>({id:t,kind:"builtin:markdown",title:e,grid:{x:r,y:s,w:n,h:o},collapsed:!1,hidden:!1,props:{markdown:i}}),F=(t,e,r,s,n,o,i,a={})=>({id:t,kind:e,title:r,grid:{x:s,y:n,w:o,h:i},collapsed:!1,hidden:!1,props:a}),pn=[{id:"agent-hq",name:"Agent HQ",summary:"Live operations overview \u2014 usage, sessions, connected instances, and schedules.",doc:Fe("board","Agent HQ",[He("header","Overview",0,0,12,2,`# Agent HQ
